...
select o.ShipCountry,
       o.ShipRegion,
       o.ShipCity,
       sum((os.Quantity * os.UnitPrice * (1 - os.Discount)) + o.Freight)
from Orders O
         join [Order Details] OS
              on O.OrderID = OS.OrderID
group by o.ShipCountry, o.ShipRegion, o.ShipCity with rollup ;
...
with eje1 as (
    ...
    having o.ShipRegion is null and o.ShipCity is null
        --RECURSIVO
    UNION ALL
    select os.ShipCountry,
           os.ShipRegion,
           os.ShipCity,
           EJE.Nivel+1 Nivel
    from Orders os join eje1 EJE on os.ShipRegion=EJE.ShipRegion and os.ShipCountry=EJE.ShipCountry
)select * from eje1;
--            last_value(o.ShipRegion) over (partition by o.ShipCountry order by o.ShipCountry) prueba
with paices as (
    select TDA1.Number,
           TDA1.ShipCountry,
           case
